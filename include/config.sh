...
mt6_defaults()
{
	...
	export TOASTER_MAILDIR="${TOASTER_MAILDIR:-"vmail"}"
...
export TOASTER_MAILDIR="vmail"  # under shared /data volume
...
export LETSENCRYPT_HOSTNAMES="\$TOASTER_HOSTNAME"
